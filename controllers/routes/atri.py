...
class Atri:
	def __init__(self, state: Any):
		...
		self.List_Items = state["List_Items"]
	...
	@property
	def List_Items(self):
		self._getter_access_tracker["List_Items"] = {}
		return self._List_Items
	@List_Items.setter
	def List_Items(self, new_state):
		self._setter_access_tracker["List_Items"] = {}
		global default_state
		self._List_Items = Flex(new_state, default_state["List_Items"])
